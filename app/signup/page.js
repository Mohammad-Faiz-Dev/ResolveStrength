    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .auth-brand-panel::before {
          ...
          background:
            radial-gradient(ellipse 90% 70% at 15% 10%, rgba(90,158,120,0.1) 0%, transparent 60%),
            radial-gradient(ellipse 70% 60% at 80% 90%, rgba(200,169,110,0.1) 0%, transparent 55%);
          pointer-events: none;
        }
        .auth-logo {
        ...
        .auth-brand-eyebrow { font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--green); font-weight: 500; margin-bottom: 1rem; }
        .auth-brand-headline { font-family: var(--font-display); font-size: clamp(1.9rem, 3vw, 2.7rem); color: var(--text-primary); line-height: 1.2; margin-bottom: 1rem; font-weight: 400; }
        ...
        .auth-pillar-icon {
          ...
          background: linear-gradient(135deg, rgba(90,158,120,0.14), rgba(200,169,110,0.08));
          border: 1px solid var(--border-green);
          display: flex; align-items: center; justify-content: center;
          font-size: 13px; color: var(--green-light); flex-shrink: 0;
        }
        ...
        .auth-form-panel::before {
          content: ''; position: absolute; inset: 0;
          background: radial-gradient(ellipse 60% 50% at 20% 80%, rgba(200,169,110,0.05) 0%, transparent 60%);
          pointer-events: none;
        }
        ...
        .auth-terms a { color: var(--green-dim); text-decoration: none; transition: color 0.15s; }
        .auth-terms a:hover { color: var(--green-light); }
        ...
        .submit-btn:hover:not(:disabled) { opacity: 0.9; transform: translateY(-1px); box-shadow: 0 8px 28px rgba(90,158,120,0.28); }
      ...
      <div className="auth-page">
        ...
        <div className="auth-brand-panel">
          ...
          <div className="auth-brand-body">
            <div className="auth-brand-eyebrow">Start your journey</div>
            <h2 className="auth-brand-headline">Build strength that<br /><em>actually lasts</em></h2>
            <p className="auth-brand-desc">
              Join a platform built on peer-reviewed science — not trends, not shortcuts.
            </p>
          </div>
          <div className="auth-pillars">
            {[
              { icon: "◈", title: "Free to Start", desc: "Full access to the core platform at no cost." },
              { icon: "⬡", title: "Science-first Content", desc: "Everything grounded in real research." },
              { icon: "◎", title: "Track & Adapt", desc: "Programs that evolve with your progress." },
            ].map((p) => (
        ...
        <div className="auth-form-panel">
          <div className="auth-card">
            ...
            <h1 className="auth-card-title">Join ResolveStrength</h1>
            <p className="auth-card-sub">Free to start. No credit card required.</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="auth-terms">
                ...
                <Link href="/about/legal/terms-and-conditions">Terms and Conditions</Link> and{" "}
                <Link href="/about/legal/privacy-policy">Privacy Policy</Link>.
              </p>

              <button type="submit" className="submit-btn" disabled={isLoading}>
                {isLoading ? <span className="spinner" /> : "Create free account"}
              </button>
            </form>
