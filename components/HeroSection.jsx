...
export default function HeroSection() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    setMessage({ type: "info", text: "Auth coming soon — Supabase is ready to connect!" });
    setTimeout(() => {
      setLoading(false);
    }, 800);
  };
        ...
        <div className="hero-inner">
          ...
          <div className="hero-copy">
            ...
            <p className="hero-sub">
              ResolveStrength brings together evidence-based research, community, and practical tools to help you build lasting mental and physical resilience — one deliberate step at a time.
            </p>
